...
pub enum InstructionArgument {
    ...
    Immediate8BitRegister8BitDisplacement {immediate: i8, register: Register, displacement: i8 },
    Immediate32BitRegister8BitDisplacement {immediate: i32, register: Register, displacement: i8 },
    Immediate8BitRegisterOpcode {immediate: u8, register: Register, opcode: u8 },
}
