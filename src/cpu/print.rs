...
impl CPU for PrintCPU {
    fn push(&mut self, _machine_state: &mut MachineState, arg: InstructionArgument) {
        println!("{:<6} {}", "push", arg);
    }
    ...
    fn mov(&mut self, _machine_state: &mut MachineState, arg: InstructionArgument) {
        println!("{:<6} {}", "mov", arg);
    }
    ...
    fn sub(&mut self, _machine_state: &mut MachineState, arg: InstructionArgument) {
        println!("{:<6} {}", "sub", arg);
    }
